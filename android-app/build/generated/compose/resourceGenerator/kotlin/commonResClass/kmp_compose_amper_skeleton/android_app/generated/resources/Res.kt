...
package kmp_compose_amper_skeleton.android_app.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/kmp_compose_amper_skeleton.android_app.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/kmp_compose_amper_skeleton.android_app.generated.resources/" +
      path)
